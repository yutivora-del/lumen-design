...
// ─── Component source (kept in sync with src/components/button.tsx) ──────────────

const buttonSource = `import type { ButtonHTMLAttributes, CSSProperties } from 'react';
...
export default function ButtonPage() {
  ...
  const handleCopy = async () => {
    await navigator.clipboard.writeText(buttonSource);
    setCopied(true);
