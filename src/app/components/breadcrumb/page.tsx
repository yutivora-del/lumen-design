...
const threeLevelsCode = `<Breadcrumb
  items={[
    { label: 'Home', href: '/' },
...
const props: { name: string; type: string; default: string; description: string }[] = [
  { name: 'items', type: '{ label: string; href?: string }[]', default: '—', description: 'Path segments; last is current' },
];

// ─── Component source (kept in sync with src/components/breadcrumb.tsx) ───────────

const breadcrumbSource = `import type { CSSProperties } from 'react';
...
export default function BreadcrumbPage() {
  ...
  const handleCopy = async () => {
    await navigator.clipboard.writeText(breadcrumbSource);
    setCopied(true);
    ...
    <>
      ...
      <div style={{ maxWidth: '1080px', margin: '0 auto', padding: '0 32px' }}>
        ...
        <section style={{ paddingTop: '96px' }}>
          ...
          >
            Where you are, and the way back. The last segment is the current page.
          </p>
        </section>
        ...
        <section style={{ paddingTop: '96px' }}>
          ...
          >
            Paste the source into components/breadcrumb.tsx. No dependencies required.
          </p>
          <div
            style={{
              position: 'relative',
