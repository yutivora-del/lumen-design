...
const initialsCode = `<Avatar initials="YV" />`;

const sizesCode = `<Avatar initials="YV" size="sm" />
<Avatar initials="YV" size="md" />
...
// ─── Component source (kept in sync with src/components/avatar.tsx) ──────────────

const avatarSource = `import type { CSSProperties } from 'react';
...
export default function AvatarPage() {
  ...
  const handleCopy = async () => {
    await navigator.clipboard.writeText(avatarSource);
    setCopied(true);
    ...
    <>
      ...
      <div style={{ maxWidth: '1080px', margin: '0 auto', padding: '0 32px' }}>
        ...
        <section style={{ paddingTop: '96px' }}>
          ...
          >
            A user, in a circle. An image when there is one, initials when there is not.
          </p>
        </section>

        {/* ─── Examples ───────────────────────────────────────────────────── */}
        <section style={{ paddingTop: '96px', display: 'flex', flexDirection: 'column', gap: '40px' }}>
          <ComponentExample title="Initials" code={initialsCode} preview={<Avatar initials="YV" />} />
          <ComponentExample
            title="Sizes"
            code={sizesCode}
            preview={
              <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                <Avatar initials="YV" size="sm" />
                <Avatar initials="YV" size="md" />
                <Avatar initials="YV" size="lg" />
              </div>
            }
        ...
        <section style={{ paddingTop: '96px' }}>
          ...
          >
            Paste the source into components/avatar.tsx. No dependencies required.
          </p>
          <div
            style={{
              position: 'relative',
