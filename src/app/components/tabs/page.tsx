...
const demoTabs = [
  { label: 'Overview', content: <p style={panelText}>A summary of the project, at a glance.</p> },
  { label: 'Details', content: <p style={panelText}>The particulars — dependencies, owners, dates.</p> },
  { label: 'History', content: <p style={panelText}>Every change, in the order it happened.</p> },
];

// ─── Example code strings ──────────────────────────────────────────────────────

const defaultCode = `const tabs = [
  { label: 'Overview', content: <p>A summary of the project, at a glance.</p> },
  { label: 'Details', content: <p>The particulars — dependencies, owners, dates.</p> },
  { label: 'History', content: <p>Every change, in the order it happened.</p> },
];
...
const props: { name: string; type: string; default: string; description: string }[] = [
  { name: 'tabs', type: '{ label: string; content: ReactNode }[]', default: '—', description: 'Tab definitions' },
  { name: 'defaultTab', type: 'number', default: '0', description: 'Initially active index' },
  { name: 'onChange', type: '(index: number) => void', default: '—', description: 'Fires on tab change' },
];

// ─── Component source (kept in sync with src/components/tabs.tsx) ────────────────
...
export default function TabsPage() {
  ...
  const handleCopy = async () => {
    await navigator.clipboard.writeText(tabsSource);
    setCopied(true);
