...
const defaultCode = `<Input placeholder="you@example.com" />`;

const labelCode = `<Input label="Email" placeholder="you@example.com" />`;

const errorCode = `<Input label="Email" error />`;
...
// ─── Component source (kept in sync with src/components/input.tsx) ───────────────

const inputSource = `import type { InputHTMLAttributes, CSSProperties } from 'react';
...
export default function InputPage() {
  ...
  const handleCopy = async () => {
    await navigator.clipboard.writeText(inputSource);
    setCopied(true);
    ...
    <>
      ...
      <div style={{ maxWidth: '1080px', margin: '0 auto', padding: '0 32px' }}>
        ...
        <section style={{ paddingTop: '96px' }}>
          ...
          >
            Text fields, restrained. An underline rather than a box — three sizes, an error state.
          </p>
        </section>
        ...
        <section style={{ paddingTop: '96px' }}>
          ...
          >
            Paste the source into components/input.tsx. No dependencies required.
          </p>
          <div
            style={{
              position: 'relative',
