...
function DialogDemo() {
  ...
  return (
    <>
      ...
      <Dialog open={open} onClose={() => setOpen(false)} title="Discard changes?">
...
const props: { name: string; type: string; default: string; description: string }[] = [
  { name: 'open', type: 'boolean', default: '—', description: 'Whether the dialog is shown' },
  { name: 'onClose', type: '() => void', default: '—', description: 'Called on escape or backdrop click' },
  { name: 'title', type: 'string', default: '—', description: 'Accessible heading' },
  { name: 'children', type: 'ReactNode', default: '—', description: 'Body content' },
];

// ─── Component source (kept in sync with src/components/dialog.tsx) ──────────────

const dialogSource = `'use client';
