...
const defaultCode = `<Tooltip content="Saves a copy">
...
const props: { name: string; type: string; default: string; description: string }[] = [
  { name: 'content', type: 'string', default: '—', description: 'Label shown on hover or focus' },
  { name: 'children', type: 'ReactNode', default: '—', description: 'The trigger element' },
  { name: 'side', type: "'top' | 'bottom' | 'left' | 'right'", default: "'top'", description: 'Placement relative to trigger' },
];

// ─── Component source (kept in sync with src/components/tooltip.tsx) ─────────────

const tooltipSource = `'use client';
...
export default function TooltipPage() {
  ...
  const handleCopy = async () => {
    await navigator.clipboard.writeText(tooltipSource);
    setCopied(true);
    ...
    <>
      ...
      <div style={{ maxWidth: '1080px', margin: '0 auto', padding: '0 32px' }}>
        ...
        <section style={{ paddingTop: '96px' }}>
          ...
          >
            A quiet aside. Hover or focus the trigger to read it; set in mono, small.
          </p>
        </section>
        ...
        <section style={{ paddingTop: '96px' }}>
          ...
          >
            Paste the source into components/tooltip.tsx. Opens on hover and keyboard focus — no dependencies required.
          </p>
          <div
            style={{
              position: 'relative',
